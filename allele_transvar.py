...
def format_for_transvar(row, genome, syntax_rules_aminoacids, syntax_rules_nucleotides):
...
if __name__ == '__main__':
    ...
    data_exploded['transvar_coordinates'] = data_exploded.progress_apply(get_transvar_coordinates, args=(anno_db,), axis=1)
