...
from grammar import allowed_types_dict, composed_types_dict, transition_old2new_aminoacid_grammar, transition_old2new_nucleotide_grammar, disruption_grammar
import pickle
import pandas
import argparse
...
if __name__ == '__main__':
    ...
    syntax_rules_aminoacids = [SyntaxRule.parse_obj(r) for r in transition_old2new_aminoacid_grammar]
    syntax_rules_nucleotides = [SyntaxRule.parse_obj(r) for r in transition_old2new_nucleotide_grammar]
