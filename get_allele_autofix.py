...
syntax_error = allele_error_data['rename_to'] != ''
...
if 'after_coords_rename_to' in allele_error_data:
    fixed_after_coord_change = seq_error & (allele_error_data['after_coords_sequence_error'] == '') & (allele_error_data['after_coords_rename_to'] != '')

    allele_error_data.loc[fixed_after_coord_change, 'fix_type'] = 'update_coordinates'
    allele_error_data.loc[fixed_after_coord_change, 'rename_to'] = allele_error_data.loc[fixed_after_coord_change, 'after_coords_rename_to']

    # Partial aminoacid deletions that did not cause errors before or after the change in coordinates
    coordinate_change_no_mutation = ~seq_error & (allele_error_data['after_coords_sequence_error'] == '') & (allele_error_data['after_coords_rename_to'] != '')
...
shift_coordinates_data = allele_error_data[shift_coordinates_fix].copy()
...
coordinate_change_creates_error_data = allele_error_data[coordinate_change_creates_error].copy()
...
coordinate_no_mutation_data = allele_error_data[coordinate_change_no_mutation].copy()
