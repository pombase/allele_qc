...
def main(input_file):
    ...
    for i, line in data.iterrows():
        ...
        if 'amino' in allele_type:
            check = check_allele_description(allele_description, syntax_rules_aminoacids, allele_type, allowed_types, genome[line['systematic_id']])
        else:
            check = check_allele_description(allele_description, syntax_rules_nucleotides, allele_type, allowed_types, genome[line['systematic_id']])
